...
use portal_proto::{
    transfer::{Background, Multiplexer, Transport},
    Header, Message, Query, Question, ToQuery,
};
    ...
    pub fn new(transport: T) -> Self {
        Self {
            background: Background {
                stream: Multiplexer::new(transport),
